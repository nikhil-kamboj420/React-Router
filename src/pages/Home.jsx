...
export const Home = () => {
  return (
    <main>
      <section>
        <div className="h-[70vh] max-w-[100vw] text-white grid grid-cols-2 lg:gap-[10rem] place-content-center items-center ml-[7rem]">
          <div className="flex flex-col gap-[3rem]">
            ...
            <div className="mt-[3rem]">
              <NavLink to="/movies"  className="explore-btn">
                Explore Now
              </NavLink>
            </div>
          </div>
          <div>
            <img
              ...
              alt="movies poster"
              className="lg:max-w-[50rem] aspect-auto mt-8"
